...
searchField.addEventListener("input", function(){
    serachTimeout ?? clearTimeout(serachTimeout);
...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather){
        const {
            weather,
            dt: dateUnix,
            sys: {sunrise: sunriseUnixUTC, sunset: sensetUnixUTC},
                    ...
                    <div class="card-list">
                        ...
                        <div class="card-item">
                            ...
                            <div>
                                ...
                                <p class="title-1">${module.getTime(sensetUnixUTC, timezone)}</p>
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            container.style.overflowY = "overlays";
